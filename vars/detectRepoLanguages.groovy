List<String> call() {
    ...
    */
    ...
    repoLanguages = sh(script: "curl --request GET '${languagesUrl}' --header 'Accept: application/vnd.github.v3+json' --header 'Authorization: token ${credentials('AUTH_TOKEN')}'", returnStdout: true).toString().trim()
